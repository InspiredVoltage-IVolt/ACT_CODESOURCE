...
[IsDomainAccount] [bit] NOT NULL CONSTRAINT [DF_Users_IsDomainAccount] DEFAULT ((0)),
...
GO
EXEC sp_addextendedproperty N'VirtualFolder', N'Users', 'SCHEMA', N'UserData', 'TABLE', N'Users', NULL, NULL
GO
